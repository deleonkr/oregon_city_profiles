## Bar or column chart in Chart.js

Sample data by U.S. Census Bureau
...
```javascript
  var TITLE = 'Population by race and Hispanic Origin';
  ...
  var X_AXIS = 'Race/Ethnicity';

  // y-axis label, label in tooltip
  var Y_AXIS = 'Percent of Populations';
